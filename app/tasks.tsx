...
type SortType = 'priority' | 'dueDate' | 'status';
...
function TaskCard({
  ...
  return (
    <TouchableOpacity
      style={[styles.card, isExpanded && { borderColor: pc }]}
      onPress={onPress}
      activeOpacity={0.88}>

      {/* Priority stripe */}
      <View style={[styles.priorityStripe, { backgroundColor: pc }]} />
      ...
      <View style={styles.cardHeader}>
        <TouchableOpacity onPress={onToggleComplete} activeOpacity={0.7} style={styles.checkboxHit}>
          <View style={[
            ...
            task.completed && { backgroundColor: Colors.outlineVariant, borderColor: Colors.outlineVariant },
          ]}>
            {task.completed
              ? <MaterialIcons name="check" size={13} color={Colors.onSurface} />
              : null}
          </View>
        </TouchableOpacity>
        ...
        <Animated.View style={[styles.listContainer, listStyle]}>
          ...
          {filteredAndSorted.length === 0 ? (
            ...
            <FlatList
              ...
              extraData={[filteredAndSorted, expandedId, editingId, editDraft]}
